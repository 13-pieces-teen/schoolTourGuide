...
public class Dijkstra<V> implements Graph<V> {
    ...
    private int size;
    private String comeOutDFS;
    private String comeOutDij;
    ...
    public void dijkstra(V v0, V vi) {
        ...
        comeOutDij = "节点" + v0 + "=>" + vi + "最短路径是: " + dist[end] + "\n"
                + str;
    }

    public String getComeOutDij()
    {
        return  comeOutDij;
    }

    public String getComeOutDFS()
    {
        return comeOutDFS;
    }
